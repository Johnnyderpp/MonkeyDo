function getArray()
{
	...
	return toDoList;//parse the data into the Array
}
...
function addTask()
{
	...
	localStorage.setItem(arary, JSON.stringify(task));	//Store the task localStorage saving to the Array
	show();
...
function show()
{
	...
	htmlFormat += "</ul>"		
	document.getElementById(array).innerHTN=ML = htmlFormat;		//Show the document
